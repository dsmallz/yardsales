...
import com.ksl.yardsales.web.AccountController;
...
privileged aspect AccountController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> AccountController.updateFromJson(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        Account account = Account.fromJsonToAccount(json);
    ...
    public ResponseEntity<String> AccountController.updateFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        for (Account account: Account.fromJsonArrayToAccounts(json)) {
            if (accountService.updateAccount(account) == null) {
